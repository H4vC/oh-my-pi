...
- Fixed Codex Astra using its larger window without opt-in; its default is 272K and Extended Context enables the documented 922K input window (1.05M total context) ([#11126](https://github.com/can1357/oh-my-pi/pull/11126) by [@H4vC](https://github.com/H4vC)).
